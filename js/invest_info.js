...
$.getJSON(
  ...
  function (data) {
    ...
    inveTable2Top.find('td:nth-child(5)').append($.number(Math.ceil(LGhnh.mrktTotAmt/naNum)))
    ...
    inveTable2Down.find('td:nth-child(5)').append($.number(Math.ceil(LGhnhWu.mrktTotAmt/naNum)))
