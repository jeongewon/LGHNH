...
// $.getJSON('경로', 할일);
$.getJSON(
  "https://apis.data.go.kr/1160100/service/GetStockSecuritiesInfoService/getStockPriceInfo?serviceKey=oZsqCqu3rv9%2Frp1M6cXfKdEN%2Fpyf02cYdsBynYdUCzHV8lbaV8yxaqtTdCqXshKxu2wwUaoIZ0%2FU2uO0cFIu5Q%3D%3D&resultType=json&itmsNm=LG%EC%83%9D%ED%99%9C%EA%B1%B4%EA%B0%95",
  function (data) {
    console.log(data);
    ...
    $(".tntn").append(Math.ceil(Dhdl.mrktTotAmt / (10 * 10000 * 10000)));
  }
);
